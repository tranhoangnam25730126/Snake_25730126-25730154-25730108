...
* **Trình biên dịch:** * MSVC (Tích hợp trong Visual Studio).
...
```bash
git clone [https://github.com/tranhoangnam25730126/Snake_KNNN.git](https://github.com/tranhoangnam25730126/Snake_KNNN.git)
cd Snake_KNNN
```
